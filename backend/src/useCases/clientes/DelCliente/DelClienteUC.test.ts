...
import { clientesRepositoryMocked, enderecosRepositoryMocked } from "../../../repositories/implementations/tests";
import { Cliente } from "../../../entities/Cliente";
import { delClienteUCTest } from ".";
import { findEnderecoByClienteUCTest } from "../../enderecos/FindEnderecoByCliente";
import { Endereco } from "../../../entities/Endereco";
import { deleteEnderecoUCTest } from "../../enderecos/DeleteEndereco";
...
describe("Testando a classe DelClienteUC", () => {
    ...
    it("Deve lançar um erro para caso não insira nenhum código do cliente", () => {
        ...
        })).rejects.toThrow("Necessário inserir um código para o cliente que quer excluir")
    });
