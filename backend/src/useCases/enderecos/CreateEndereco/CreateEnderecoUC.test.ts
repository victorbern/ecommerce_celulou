...
const clienteExistsUCTest = clienteFactoryTest.useCases.clienteExistsUseCase();

const createEnderecoUCTest = new CreateEnderecoUC(enderecosRepositoryMocked, clienteExistsUCTest);
...
describe("Testando a classe CreateEnderecoUC", () => {
    ...
    it("Deve ser possível cadastrar um novo endereço", async () => {
        vi.spyOn(clienteExistsUCTest, 'execute').mockResolvedValue(true);
    ...
    it("Não deve ser possível cadastrar um novo endereço caso o cliente não seja especificado corretamente", () => {
        ...
        vi.spyOn(clienteExistsUCTest, 'execute').mockResolvedValue(false);
